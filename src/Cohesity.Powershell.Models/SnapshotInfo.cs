...
namespace Cohesity.Model
{
    ...
    public partial class SnapshotInfo :  IEquatable<SnapshotInfo>
    {
        ...
        [DataMember(Name="relativeSnapshotDirectory", EmitDefaultValue=true)]
